...
plt.plot(np.arange(T), ftrl_regret, label=r"FTRL", linewidth=5.2, color="#50C878", linestyle='--', markevery=2000)
...
plt.savefig("./ftrl-es.pdf", bbox_inches = 'tight',pad_inches = 0)
plt.show()
