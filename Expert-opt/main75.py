...
meta_agents = [OGDExpertsAgent(files=files, max_cache_size=max_cache_size, rho = 0.75) for i in range(trials)]
...
with open('./conf_plots75/BH.npy', 'wb') as f:
    np.save(f, util_BHS)

with open('./conf_plots75/META.npy', 'wb') as f:
    np.save(f, util_META)

with open('./conf_plots75/META_BAD.npy', 'wb') as f:
