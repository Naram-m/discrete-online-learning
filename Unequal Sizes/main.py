...
with open('./conf_plots_depround2/BH.npy', 'wb') as f:
    np.save(f, util_BHS)

with open('./conf_plots_depround2/FTPL.npy', 'wb') as f:
    np.save(f, util_FTPL)

with open('./conf_plots_depround2/O_FTPL.npy', 'wb') as f:
    np.save(f, util_O_FTPL)

with open('./conf_plots_depround2/O_FTPL_0.npy', 'wb') as f:
    np.save(f, util_O_FTPL_0)

with open('./conf_plots_depround2/FTRL.npy', 'wb') as f:
    np.save(f, util_FTRL)

with open('./conf_plots_depround2/O_FTRL.npy', 'wb') as f:
    np.save(f, util_O_FTRL)

with open('./conf_plots_depround2/O_FTRL_0.npy', 'wb') as f:
    np.save(f, util_O_FTRL_0)

# with open('./conf_plots/BH.npy', 'wb') as f:
#     np.save(f, util_BHS)
#
# with open('./conf_plots/FTPL.npy', 'wb') as f:
#     np.save(f, util_FTPL)
#
# with open('./conf_plots/O_FTPL.npy', 'wb') as f:
#     np.save(f, util_O_FTPL)
#
# with open('./conf_plots/O_FTPL_0.npy', 'wb') as f:
#     np.save(f, util_O_FTPL_0)
#
# with open('./conf_plots/FTRL.npy', 'wb') as f:
#     np.save(f, util_FTRL)
#
# with open('./conf_plots/O_FTRL.npy', 'wb') as f:
#     np.save(f, util_O_FTRL)
#
# with open('./conf_plots/O_FTRL_0.npy', 'wb') as f:
#     np.save(f, util_O_FTRL_0)
