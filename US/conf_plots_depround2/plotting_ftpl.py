...
plt.plot(np.arange(T), o_ftpl_regret, label=r"OFTPL, $\rho=0.75$", linewidth=3, color="blue", marker='o', markevery=2000, markersize=9)
plt.plot(np.arange(T), o_ftpl_sin_regret, label=r"OFTPL, $\rho=0.2\sin\left(\frac{t\pi}{10^3}\right)+0.7$", linewidth=2, color="#E1C16E", marker='p', markevery=2000, markersize=7, markeredgecolor='black')
...
plt.savefig("./ftpl-us-500.pdf", bbox_inches = 'tight',pad_inches = 0)
plt.show()
##################################
